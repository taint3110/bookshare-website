...
import { Box, Table as CkTable, HStack, Link, Stack, Tbody, Td, Text, Th, Thead, Tr } from '@chakra-ui/react'
...
import { Column, PluginHook, useExpanded, useSortBy, useTable } from 'react-table'
  ...
  return (
    <Stack spacing="24px">
      <Box
        ...
        background="white"
        overflow={getValidArray(rows)?.length < 6 && route.includes('application-management') ? 'unset' : 'auto'}
        width="100%"
      >
